...
define([
    ...
    return Backbone.View.extend({
        initialize: function (options) {
            ...
            var self = this;
            this.model.on('change:api_type', function () {
                var api_type = self.model.get("api_type");

                if (api_type === 'Streaming') {
                    self.model.set('endpoint', 'https://firehose.crowdstrike.com/sensors/entities/datafeed/v1');
                } else {
                    self.model.set('endpoint', '');
                }
            });
        },
